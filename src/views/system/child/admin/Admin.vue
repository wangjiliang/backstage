<template>
  <div>
    <el-table class="tableData"  ref="multipleTable" highlight-current-row :data="tableData"
      ...
      <el-table-column prop="name" label="管理员" show-overflow-tooltip></el-table-column>
    ...
    <AdminOperation v-if="showModal || isAdd" :row="row" @hide="hide" @confirm="handleConfirm"/>
  </div>
</template>
...
export default {
  ...
  methods: {
    fetchData(pageNum, pageSize) {
      ...
      this.http.get(this.api.admin.get, params).then( res => {
